...
print("We Have Data inside the object 'in_string'")
print("-"*20)
# --------------------
...
print("Inside the object 'in_string' we have methods also")
print("-"*20)
# --------------------
...
# --------------------
# ENCAPSULATION: Keeping data & related methods inside each object
# --------------------

# --------------------
# Abstraction: We can access/interact using methods. No need to know
